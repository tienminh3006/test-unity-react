...
function UnityTest() {
	function handleCacheControl(url: string): UnityCacheControlMode {
		...
		return "no-cache" as UnityCacheControlMode;
	}
	...
	return (
		<Fragment>
			...
			<p>
				...
				<button onClick={handleClickRequestPointerLock}>Request Pointer Lock</button>
				...
				<br />
				Other:
				<button onClick={handleClickSetRandomCanvasWidth}>Set Random Canvas Width</button>
			</p>
			<Unity
